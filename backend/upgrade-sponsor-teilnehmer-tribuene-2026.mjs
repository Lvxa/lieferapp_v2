...
// Sponsorenzelt: Cola/Zero/Fanta/Sprite als 0,2-l-Glasware plus die drei Töftes 0,33 l, keine Kasse.
upsertStand({
  code: 'sponsorenzelt',
  name: 'Sponsorenzelt',
  type: 'sponsor',
...
const sponsorSmallIds = new Set([12, 15, 18, 21, 27, 28, 29]);
